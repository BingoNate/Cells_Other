...
""" Plot spatial displacement correlation per transition 
...
def plot_data(x, data, param_choice, sims, savebase, savefolder):
    ...
    ax0.set_ylabel(r"$C_{d}(r)$", fontsize=30)
    ...
    ax0.xaxis.set_ticks([0, 20, 40, 60])
    ax0.yaxis.set_ticks([-0.2, 0.2, 0.6, 1.0])
...
def main():
    ...
    analysistype = "Sp_velocity_corr_subt"
    ...
    savefolder = "Sp_velocity_corr_subt"
