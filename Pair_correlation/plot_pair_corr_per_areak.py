...
""" Plot the pair correlation function per area constraint potential parameter"""
...
def main():
    ...
    parser.add_argument("-sf", "--savefolder", nargs="?", const="Pair_corr", \
                        help="Specific folder for saving, as in Pair_corr")   
