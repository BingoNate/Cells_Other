...
""" Plot global polar order per area constraint potential parameter"""
...
def main():
    ...
    parser.add_argument("-sf", "--savefolder", nargs="?", const="Polar_order_intrinsic", \
                        help="Specific folder for saving, as in Polar_order_intrinsic")   
