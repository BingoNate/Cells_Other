...
template<int DIM> struct KDtree {
    ...
    void nnearest( int jpt, vector<int> & nn, vector<double> & dn, int n );
    static void sift_down( vector<double> & heap, vector<int> & ndx, int nn );        // used by nnearest
...
template<int DIM> void KDtree<DIM>::nnearest(int jpt, vector<int> & nn, vector<double> & dn, int n){
...
template<int DIM> void KDtree<DIM>::sift_down(vector<double> & heap, vector<int> & ndx, int nn){
